...
class _AdminAttendancePageState extends State<AdminAttendancePage> {
  ...
  Future<void> _initializeData() async {
    try {
      ...
      print('❌ ATTENDANCE PAGE: Error inicializando - $e');
      setState(() {
  ...
  Future<void> _loadAttendanceForDate(DateTime date) async {
    ...
    try {
      print(
        '📅 ATTENDANCE PAGE: Cargando asistencia para ${date.toIso8601String().split('T')[0]}',
      );
      ...
      print(
        '✅ ATTENDANCE PAGE: ${attendanceData.alumnos.length} alumnos cargados',
      );
    } catch (e) {
      print('❌ ATTENDANCE PAGE: Error cargando asistencia - $e');
      setState(() {
  ...
  Future<void> _updateAttendance(
    ...
    try {
      print('📝 ATTENDANCE PAGE: Actualizando asistencia individual');
      ...
      print('❌ ATTENDANCE PAGE: Error actualizando asistencia - $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
