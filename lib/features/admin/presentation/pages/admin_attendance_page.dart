      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              CircleAvatar(
                ...
                radius: 20,
                child: Text(
                  student.nombre.isNotEmpty ? student.nombre[0].toUpperCase() : 'A',
          ...
          Row(
            children: [
              Expanded(
                child: _buildAttendanceButton('Presente', AttendanceStatus.presente, Colors.green,
              ...
              Expanded(
                child: _buildAttendanceButton('Faltó', AttendanceStatus.falto, Colors.red,
              ...
              const SizedBox(width: 8),
              Expanded(
                child: _buildAttendanceButton('Permiso', AttendanceStatus.permiso, Colors.orange,
