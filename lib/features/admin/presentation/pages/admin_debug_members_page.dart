...
class _AdminDebugMembersPageState extends State<AdminDebugMembersPage> {
  ...
  Future<void> _linkAdminToGym(String gymKey) async {
    try {
      print('🔗 DEBUG: Vinculando admin con clave: $gymKey');
      ...
      print('✅ DEBUG: Admin vinculado exitosamente');
      print('📊 DEBUG: Respuesta: ${response.data}');
      ...
      print('❌ DEBUG: Error vinculando admin - $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
