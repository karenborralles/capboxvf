...
class CoachPerformanceTest7Page extends StatefulWidget {
  const CoachPerformanceTest7Page({super.key});

  @override
  State<CoachPerformanceTest7Page> createState() => _CoachPerformanceTest7PageState();
}

class _CoachPerformanceTest7PageState extends State<CoachPerformanceTest7Page> {
  ...
  Widget _instructionBox() => Container(
        ...
        child: const Text(
          ...
          '(Descansar un minuto después de esto)',
